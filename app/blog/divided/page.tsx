    ...
    >
      ...
      <div className="flex flex-col items-start justify-start flex-grow max-w-3xl mx-auto w-full">
        ...
        <article className="prose space-y-6 -mt-5">
          ...
          <p>Electing such a polarizing figure as one of the most important positions in the country — and the world — has only exacerbated the divide. His rhetoric and uncharismatic approach to issues, like race, has only worsened relations between the two sides of the political spectrum.</p>
          <p>But blaming our country's division on one man is quite childish: his presidency would not have been possible without the support of his own — almost cultish — followers. In reality, the real cause of this divide is people's unwillingness to accept that others are entitled to different opinions.</p>
