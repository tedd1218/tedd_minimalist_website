    ...
    >
      ...
      <div className="flex flex-col items-start justify-start flex-grow max-w-3xl mx-auto w-full">
        ...
        <article className="prose space-y-6 -mt-5">
          <p><span className="italic">Originally published in <a href="https://www.michigandaily.com/statement/my-grandfathers-harmonium/?fbclid=PAZXh0bgNhZW0CMTEAAacWS_esCwIaTsSTnhvra5MJLpGZySIsYZ5sj-Z5j2h7Z10G73-2d0An09yuzQ_aem_2J_OlNDLhytUxYEUYKzBSg" className="underline text-[#FFCC00] hover:opacity-80" target="_blank" rel="noopener noreferrer">The Michigan Daily</a>, this piece was authored by <a href="https://www.linkedin.com/in/isha-jayadev-603302187/" className="underline text-[#FFCC00] hover:opacity-80" target="_blank" rel="noopener noreferrer">Isha Jayadev</a>, a senior economics major and creative writing minor at the University of Michigan. You can reach her at <a href="mailto:ishajay@umich.edu" className="underline text-[#FFCC00] hover:opacity-80" target="_blank" rel="noopener noreferrer">ishajay@umich.edu</a>.</span></p>
